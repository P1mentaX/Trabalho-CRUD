...
- 📄 **`AtividadeFinal.zip`** → projeto completo do NetBeans  
- 📄 **`Atividade - Eduardo Pimenta - Marco Aurelio - Nael Barreto - Vinicius Ferreira.pdf`** → documentação detalhada com **MER (Modelo Entidade-Relacionamento)** e scripts SQL  
- 📄 **`postgresql-42.7.0.jar`** → driver JDBC para conexão com o banco (caso precise rodar fora do NetBeans)  

---

## 🎥 Demonstração em Vídeo
O projeto foi explicado em vídeos curtos, disponíveis no YouTube (não listados):  
...
1. **Descompacte** o arquivo `AtividadeFinal.zip`.  
2. Abra o projeto no **NetBeans IDE**.  
3. Configure o **driver JDBC** (`postgresql-42.7.0.jar`) no projeto, se necessário.  
4. Crie o **banco de dados** no PostgreSQL utilizando os scripts SQL fornecidos na documentação.  
5. Execute a **classe principal**: `TelaLogin` (primeira tela do sistema).  

---

## ✅ Observações
- O projeto segue os conceitos de **Programação Orientada a Objetos (POO)** e boas práticas de desenvolvimento.  
- Todas as funcionalidades do CRUD estão implementadas e testadas, permitindo **criar, visualizar, atualizar e excluir registros** no banco de dados.  
- Inclua prints ou GIFs para que avaliadores vejam rapidamente o funcionamento do sistema.
